...
// Wrapper that runs chrome-devtools-mcp but picks a working browserUrl.
// This helps in WSL/Windows split setups where localhost may not route to the host Chrome.
